...
// Custom icon for the capital city marker
...
// Define the style function to apply color to highlighted countries
...
const Map = () => {
  ...
  // Change the mode when you click the toggle button
